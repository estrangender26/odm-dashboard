...
async function drop() {
    ...
    await conn.execute('DROP TABLE IF EXISTS governance_uploads');
    await conn.execute('DROP TABLE IF EXISTS governance_milestone_state');
    await conn.execute('DROP TABLE IF EXISTS governance_facilities');
