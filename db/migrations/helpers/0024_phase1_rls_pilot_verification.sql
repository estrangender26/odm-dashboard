-- Migration 0024 Phase 1 RLS pilot: read-only post-forward verification.
-- Expected after the forward migration:
--   rls_enabled=true, force_rls=false, policy_count=0
--   anon/authenticated have none of the seven table privileges.
