...
def pc_body():
    ...
    return (
        ...
        '<span class="odm-faint" style="font-size:11.5px">Sorted by newest first</span>'
        '</div>\n'
        '  </section>\n'
        ...
        '<span class="odm-faint">Library and Generators are the existing tabs</span></div></div></section>\n'
        '  <section class="odm-section">'
