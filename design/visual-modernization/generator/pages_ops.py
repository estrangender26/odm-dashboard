...
def odm_body():
    ...
    ins = "".join(
        ...
        '<div class="odm-insight-body">%s</div></div></div>' % (sev, sev.upper(), title, body)
    ...
    return (
        ...
        '  <span class="odm-field odm-field--inline"><label class="odm-label">DATE FROM</label>'
        '<input class="odm-input" value="2026-01-01" style="width:130px"></span>\n'
        '  <span class="odm-field odm-field--inline"><label class="odm-label">DATE TO</label>'
        '<input class="odm-input" value="2026-08-31" style="width:130px"></span>\n'
        '  <span class="odm-field odm-field--inline"><label class="odm-label">PLANT / FACILITY</label>'
        ...
        '  <span class="odm-field odm-field--inline"><label class="odm-label">EQUIPMENT TYPE</label>'
        '<select class="odm-select"><option>All Types</option></select></span>\n'
        '  <span class="odm-field odm-field--inline"><label class="odm-label">CATEGORY</label>'
        '<select class="odm-select"><option>All Categories</option></select></span>\n'
        '  <span class="odm-field odm-field--inline"><label class="odm-label">INSPECTOR</label>'
        ...
        '      <div class="odm-chart-note"><span class="odm-badge odm-badge--danger">CUMULATIVE DISTINCT NEGATIVE FINDINGS</span></div></div></div>\n'
        '    <div class="odm-card"><div class="odm-card-head">'
        ...
        '      <div class="odm-chart-note"><span class="odm-badge odm-badge--warning">EQUIPMENT TYPES AT 80%</span></div></div></div>\n'
        '  </div></section>\n'
        ...
        '      <span class="odm-faint" style="font-size:11.5px">Filtered by: Plant / Facility = All Plants</span></div>'
