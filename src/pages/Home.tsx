          ...
          >
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14, marginBottom: 10 }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <p style={{ fontSize: 12, color: '#8BA3B8', margin: '4px 0 0' }}>
                  Masterdata submission portal for projects without PPP packages.
                </p>
              </div>
            </div>
            <p style={{ fontSize: 14, color: '#5A6B7D', lineHeight: 1.6, margin: '0 0 14px' }}>
              Submit project masterdata, manage tracking IDs, PS codes, work packages, and attach supporting documents to Supabase storage.
            </p>
            <div style={{ display: 'flex', gap: 8, marginBottom: 14, flexWrap: 'wrap' }}>
              <span style={{ fontSize: 11, fontWeight: 600, padding: '3px 10px', borderRadius: 12, background: '#DBEAFE', color: '#005BAC' }}>Masterdata</span>
              <span style={{ fontSize: 11, fontWeight: 600, padding: '3px 10px', borderRadius: 12, background: '#FEF3C7', color: '#D97706' }}>Submit</span>
              <span style={{ fontSize: 11, fontWeight: 600, padding: '3px 10px', borderRadius: 12, background: '#D1FAE5', color: '#059669' }}>Supabase Storage</span>
            </div>
            <span style={{ fontSize: 13, fontWeight: 600, color: '#005BAC', display: 'flex', alignItems: 'center', gap: 4 }}>
              Open Portal →
            </span>
