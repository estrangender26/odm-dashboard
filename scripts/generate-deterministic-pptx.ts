/**
 * Deterministic Governance Presentation Generator for Validation
 * Uses test fixtures to generate a PPTX without database dependency
 */
...
const testFacilities = [
  {
    ...
    documentSummary: {
      totalDocuments: 6, // Multiple files
...
async function generateValidationArtifacts() {
  console.log("Generating deterministic governance presentation...");
  ...
  // Generate PPTX
  const pptx = await generateGovernancePresentation(testFacilities as any, "2026-07-25");
